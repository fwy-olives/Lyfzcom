...
final class Response
{
    ...
    {
        return \Lyfzcom\json_decode((string) $body, true, 512);
    }
    ...
    private static function isJson($headers)
    {
        ...
        strpos($headers['Content-Type'], 'application/json') ===0 )||(array_key_exists('content-type', $headers) &&
